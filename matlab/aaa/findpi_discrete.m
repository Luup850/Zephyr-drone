% function to evaluate PI controller parameters 
% based on system, Ni and desired phasemargin
%
% [wc, Kp, ti, ok] = solvepd(G1, gm, Ni, w)
%            G1 is system to design for
%            gm is desired phase margin (degrees)
...
% 
function [wc, Kp, taui, ok] = findpi_discrete(G1, gm, Ni, time, w)
